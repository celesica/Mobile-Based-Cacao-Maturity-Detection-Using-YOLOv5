...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        if (modelFilename.equals("cacao-fp16.tflite")) {
        ...
        else if (modelFilename.equals("cacao-int8.tflite")) {
            labelFilename = "file:///android_asset/customclasses.txt";
            isQuantized = true;
            inputSize = 416;
...
//        else if (modelFilename.equals("cacao-640-fp16.tflite")) {
//            labelFilename = "file:///android_asset/customclasses.txt";
//            isQuantized = false;
//            inputSize = 640;
//            output_width = new int[]{80, 40, 20};
...
//            };
//        }
//        else if (modelFilename.equals("cacao-640-int8.tflite")) {
//            labelFilename = "file:///android_asset/customclasses.txt";
//            isQuantized = true;
//            inputSize = 640;
//            output_width = new int[]{40, 20, 10};
